#usage: $1 mode (BF, SNIGUpdate, SNIG, or GPipe), default is SNIG"
#       $2 num_neurons
#       $3 num_layers
#       $4 num_gpus
#       $5 batch_size
...
get_command() {
  ...
  num_duplicates=${6:-$default_num_duplicates}
  num_times=${7:-$default_num_times}

  get_bias $num_neurons

  for (( t = 0; t < ${num_times}; ++t ))
  do
    ./snig -m $mode -w ../dataset/weight/neuron$num_neurons/ --num_neurons $num_neurons --num_layers $num_layers --input ../dataset/MNIST/sparse-images-$num_neurons.b --golden ../dataset/MNIST/neuron$num_neurons-l$num_layers-categories.b --bias $bias --num_gpus $num_gpus --input_batch_size $input_batch_size --num_duplicates $num_duplicates
  done
